...
import * as ArticleController from "../services/article.controller"
...
//     ,async (req: express.Request, res: any|express.Response) => {
//     try {
//
//         //console.log(res);
...
router.get("/my", Middleware.verifyToken, ArticleController.getMyArticle
//     async(req, res:any) => {
//     try {
//
...
router.put("/",Middleware.verifyToken , ArticleController.updateArticles
//     async (req, res:any) =>{
//
